    ...
    return (
        <div className="px-4 lg:px-10 pb-10 space-y-8 lg:space-y-10 pt-6 lg:pt-0" dir="rtl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                ...
                <div className="bg-white rounded-[2rem] p-6 lg:p-8 border border-slate-100 shadow-sm flex items-center justify-between col-span-1 lg:col-span-2">
                    <div>
            ...
            <div className="bg-white rounded-[2rem] lg:rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden">
                {/* Custom Filters Bar */}
                <div className="p-6 lg:p-8 border-b border-slate-50 flex flex-col sm:flex-row sm:items-center justify-between bg-slate-50/20 gap-4">
                    <div className="flex items-center gap-4">
                        <span className="text-xs lg:text-sm font-bold text-slate-400">
                            {filteredProducts.length > 0 ? `عرض 1-${filteredProducts.length} من أصل ${filteredProducts.length}` : 'لا توجد بيانات لعرضها'}
                        </span>
                    </div>
                    <div className="flex flex-wrap items-center gap-3 lg:gap-4">
                        <select
                            ...
                            className="px-4 lg:px-6 py-2.5 lg:py-3 bg-indigo-50 border border-indigo-100 rounded-xl lg:rounded-2xl text-indigo-600 font-bold text-[10px] lg:text-xs shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 cursor-pointer appearance-none pl-10"
                ...
                {/* Pagination */}
                {products.length > 0 && (
                    <div className="p-6 lg:p-8 border-t border-slate-50 flex items-center justify-between bg-slate-50/10">
                        <button className="flex items-center gap-2 px-4 lg:px-6 py-2 lg:py-3 bg-white border border-slate-100 rounded-xl lg:rounded-2xl text-slate-400 font-bold text-[10px] lg:text-xs shadow-sm hover:text-indigo-600 transition-all">
                            <svg className="w-4 h-4 text-right" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M15 19l-7-7 7-7" />
                            </svg>
                            السابق
                        </button>
                        <div className="flex items-center gap-2 lg:gap-3">
                            <button className="w-8 h-8 lg:w-10 lg:h-10 flex items-center justify-center rounded-lg lg:rounded-xl bg-indigo-600 text-white font-bold text-xs lg:text-sm shadow-lg shadow-indigo-600/20">1</button>
                        </div>
                        <button className="flex items-center gap-2 px-4 lg:px-6 py-2 lg:py-3 bg-white border border-slate-100 rounded-xl lg:rounded-2xl text-slate-400 font-bold text-[10px] lg:text-xs shadow-sm hover:text-indigo-600 transition-all">
                            التالي
                            <svg className="w-4 h-4 text-left" fill="none" viewBox="0 0 24 24" stroke="currentColor">
