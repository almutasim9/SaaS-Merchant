...
export default function PlatformSettingsPage() {
    ...
    return (
        <div className="p-8 pb-32 lg:pb-8 max-w-5xl mx-auto space-y-8 animate-in fade-in duration-500 font-sans" dir="rtl">
            <div>
                <h1 className="text-3xl font-black text-slate-900 tracking-tight">إعدادات المنصة</h1>
                <p className="text-slate-500 mt-2 font-medium">إدارة معلومات التواصل والروابط وتفاصيل المنصة الأساسية الخاصة بك.</p>
            </div>
            ...
            <form onSubmit={handleSave} className="space-y-6">
                ...
                <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-slate-500">رقم الهاتف (للاتصال)</label>
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-slate-500">البريد الإلكتروني الرسمي</label>
                ...
                <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-slate-500">رابط صفحة فيسبوك</label>
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-slate-500">حساب الانستجرام</label>
                ...
                <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-slate-500">اسم المنصة (عربي)</label>
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-slate-500">اسم المنصة (إنجليزي)</label>
                ...
                <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm space-y-6">
                    ...
                    <div className="space-y-2">
                        <label className="text-xs font-bold text-slate-500">أسماء العلامات التجارية (مفصولة بفاصلة)</label>
                        ...
                        <p className="text-[11px] text-slate-400">ستظهر هذه القائمة بشكل متحرك في قسم الـ Hero على الصفحة الرئيسية لإعطاء انطباع بالثقة.</p>
                    </div>
                </div>
