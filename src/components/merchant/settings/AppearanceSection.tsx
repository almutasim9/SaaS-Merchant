            ...
            <div className="relative">
                {!hasCustomTheme && (
                    <div className="absolute inset-0 z-10 backdrop-blur-[2px] bg-slate-50/50 flex items-center justify-center -m-6 lg:-m-10">
                        <div className="bg-white px-6 py-4 rounded-2xl shadow-xl flex flex-col items-center gap-2 border border-slate-100 max-w-sm text-center">
                            ...
                            <p className="text-xs text-black font-medium">تغيير ألوان المتجر متاح للباقات المتقدمة (الفضية والذهبية). يرجى الترقية.</p>
                        </div>
                    </div>
                )}
                ...
                <div className={!hasCustomTheme ? 'pointer-events-none' : ''}>
                    <div className="space-y-1">
                        <label className="text-[9px] lg:text-[10px] font-bold text-black uppercase tracking-widest pr-1">اللون الأساسي</label>
                        <div className="flex items-center gap-2">
                            ...
                            />
                            <div className="flex-1 bg-[#FBFBFF] border border-slate-100 rounded-lg lg:rounded-xl px-4 py-2 text-xs lg:text-sm font-bold text-black flex items-center justify-between" dir="ltr">
                        ...
                        <p className="text-[9px] text-black">سيستخدم هذا اللون في الأزرار والعناصر البارزة.</p>
                    </div>
                </div>
            </div>
        </Card>
